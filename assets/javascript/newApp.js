...
function timer1() {
    $("#quiz").show();
    var timeLeft = 5;
    var elem = $("#timeRemaining").text(timeLeft + " seconds remaining");
    ...
    function countdown() {
        if (timeLeft == 0) {
            ...
            $("#results").show();
            myInterval = setTimeout(timer2, 3000);
...
function timer2() {
    ...
    $(".wrong").on("click", function () {
        ...
        $("img").attr("src", "https://media.giphy.com/media/3o6gDWzmAzrpi5DQU8/giphy.gif");
        $("#results").show();
        myInterval = setTimeout(timer3, 3000);
...
function timer3() {
    ...
    function countdown() {
        if (timeLeft == 0) {
            ...
            $("#results").show();
            myInterval = setTimeout(timer4, 3000);
